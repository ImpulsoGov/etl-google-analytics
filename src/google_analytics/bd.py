...
from google_analytics.utilitarios.bd import TabelasRefletidasDicionario
...
BD_HOST: Final[str] = os.getenv("GAETL_BD_HOST", "localhost")
BD_PORTA: Final[int] = int(os.getenv("GAETL_BD_PORTA", "5432"))
BD_NOME: Final[str] = os.getenv("GAETL_BD_NOME", "principal")
BD_USUARIO: Final[str] = os.getenv("GAETL_BD_USUARIO", "etl")
BD_SENHA: Final[str | None] = os.getenv("GAETL_BD_SENHA", None)
